...
location.reload(); // this line to be included for phone version
}
...
xmlhttp.onreadystatechange=function()
  {
    if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
		if (xmlhttp.responseText == "Sorry")
			{
			window.location = 'index.html#rehome4';
			}
		else
			{
			// append the list from rehomeSearchDB.php to dblist
			$('#rehomedblist').append(xmlhttp.responseText);
...
xmlhttp.onreadystatechange=function()
  {
	...
	$dateAdded = jsonObject.day+"/"+jsonObject.month+"/"+jsonObject.year;
	$telephone = jsonObject.telephone;
	$email = jsonObject.email;
	$contact = jsonObject.ownersName;

	document.getElementById("rehomeChosenListingTitle").innerHTML="<p id='rehomeTitle'>"+$title+"</p>";

	document.getElementById("rehomeChosenListingLocation").innerHTML="Location&nbsp&nbsp Co. "+$county;
	document.getElementById("rehomeChosenListingAdded").innerHTML="Added&nbsp&nbsp&nbsp&nbsp&nbsp "+$dateAdded;
	document.getElementById("rehomeChosenListingContact").innerHTML="Contact&nbsp&nbsp&nbsp "+$contact;
	document.getElementById("rehomeChosenListingPrice").innerHTML= "Price&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp "+$price;
	document.getElementById("rehomeChosenListingPhone").innerHTML="Phone&nbsp&nbsp&nbsp&nbsp&nbsp "+$telephone;

	if ($email == "")
	{
	document.getElementById("rehomeChosenListingEmail").innerHTML="";
	document.getElementById("rehomeChosenListingEmailDiv").innerHTML=""; // clear any previous icon
	}
	else
	{
	document.getElementById("rehomeChosenListingEmail").innerHTML= "Email&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp "+$email;
	document.getElementById("rehomeChosenListingEmailDiv").innerHTML='<a href="mailto:'+$email+'" ><img id=rehomeEmailIcon class="emailIcon" onMousedown="downImg18(this)" onMouseup="upImg18(this)" src="ButtonEmailUpScaled.png"></a>';
	}

	document.getElementById("rehomeChosenListingPhoneDiv").innerHTML='<a href="tel:'+$telephone+'"><img id="rehome3phone" onMousedown="downImg17(this)" onMouseup="upImg17(this)" src="ButtonPhoneUpScaled.png"></a>';


// the line below to include the a href with $email address written into the div (if it works like a telephone number)


	document.getElementById("rehomeChosenListingDescription").innerHTML=$description;
...
xmlhttp.onreadystatechange=function()
  {
    if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
		if (xmlhttp.responseText == "Sorry")
			{
			window.location = 'index.html#lost4';
			}
		else
			{
			// append the list from lostSearchDB.php to dblist
			$('#lost2dblist').append(xmlhttp.responseText);
...
xmlhttp.onreadystatechange=function()
  {
	...
	$price = jsonObject.price;
	$dateAdded = jsonObject.day+"/"+jsonObject.month+"/"+jsonObject.year;
	$dateLost = jsonObject.lfday+"/"+jsonObject.lfmonth+"/"+jsonObject.lfyear;
	$telephone = jsonObject.telephone;
	$email = jsonObject.email;
	$contact = jsonObject.ownersName;

	document.getElementById("lostChosenListingTitle").innerHTML="<p id='lostTitle'>"+$title+"</p>";
	document.getElementById("lostDate").innerHTML="<strong>Lost "+$dateLost+"</strong>";
	document.getElementById("lostChosenListingLocation").innerHTML="Location&nbsp&nbsp Co. "+$county;
	document.getElementById("lostChosenListingAdded").innerHTML="Added&nbsp&nbsp&nbsp&nbsp&nbsp "+$dateAdded;
	document.getElementById("lostChosenListingContact").innerHTML="Contact&nbsp&nbsp&nbsp "+$contact;

	document.getElementById("lostChosenListingPhone").innerHTML="Phone&nbsp&nbsp&nbsp&nbsp&nbsp "+$telephone;

	document.getElementById("lostChosenListingPhoneDiv").innerHTML='<a href="tel:'+$telephone+'"><img id="lost3phone" onMousedown="downImg17(this)" onMouseup="upImg17(this)" src="ButtonPhoneUpScaled.png"></a>';

	if ($email == "")
	{
	document.getElementById("lostChosenListingEmail").innerHTML="";
	document.getElementById("lostChosenListingEmailDiv").innerHTML=""; // clear any previous icon
	}
	else
	{
	document.getElementById("lostChosenListingEmail").innerHTML= "Email&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp "+$email;
	document.getElementById("lostChosenListingEmailDiv").innerHTML='<a href="mailto:'+$email+'"><img id=lostEmailIcon class="emailIcon" onMousedown="downImg18(this)" onMouseup="upImg18(this)" src="ButtonEmailUpScaled.png"></a>';
	}


// the line below to include the a href with $email address written into the div (if it works like a telephone number)
	document.getElementById("lostChosenListingDescription").innerHTML=$description;
...
xmlhttp.onreadystatechange=function()
  {
    if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
		if (xmlhttp.responseText == "Sorry")
			{
			window.location = 'index.html#found4';
			}
		else
			{
			// append the list from foundSearchDB.php to dblist
			$('#foundPetsdblist').append(xmlhttp.responseText);
...
xmlhttp.onreadystatechange=function()
  {
	...
	$price = jsonObject.price;
	$dateAdded = jsonObject.day+"/"+jsonObject.month+"/"+jsonObject.year;
	$dateFound = jsonObject.lfday+"/"+jsonObject.lfmonth+"/"+jsonObject.lfyear;
	$telephone = jsonObject.telephone;
	$email = jsonObject.email;
	$contact = jsonObject.ownersName;

	document.getElementById("foundChosenListingTitle").innerHTML="<p id='foundTitle'>"+$title+"</p>";
	document.getElementById("foundDate").innerHTML="<strong>Found "+$dateFound+"</strong>";
	document.getElementById("foundChosenListingLocation").innerHTML="Location&nbsp&nbsp Co. "+$county;
	document.getElementById("foundChosenListingAdded").innerHTML="Added&nbsp&nbsp&nbsp&nbsp&nbsp "+$dateAdded;
	document.getElementById("foundChosenListingContact").innerHTML="Contact&nbsp&nbsp&nbsp "+$contact;
	document.getElementById("foundChosenListingPhone").innerHTML="Phone&nbsp&nbsp&nbsp&nbsp&nbsp "+$telephone;
	document.getElementById("foundChosenListingPhoneDiv").innerHTML='<a href="tel:'+$telephone+'"><img id="found3phone" onMousedown="downImg17(this)" onMouseup="upImg17(this)" src="ButtonPhoneUpScaled.png"></a>';


	if ($email == "")
	{
	document.getElementById("foundChosenListingEmail").innerHTML="";
	document.getElementById("foundChosenListingEmailDiv").innerHTML=""; // clear any previous icon
	}
	else
	{
	document.getElementById("foundChosenListingEmail").innerHTML= "Email&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp "+$email;
	document.getElementById("foundChosenListingEmailDiv").innerHTML='<a href="mailto:'+$email+'"><img id=foundEmailIcon class="emailIcon" onMousedown="downImg18(this)" onMouseup="upImg18(this)" src="ButtonEmailUpScaled.png"></a>';
	}

	document.getElementById("foundChosenListingDescription").innerHTML=$description;
    }
  };
xmlhttp.open("GET",useurl+"getChosenListing.php?theID="+$ads_id,true);
xmlhttp.send();
...
//	$('#addalistingDdmenuResults').html("Your choice: "+ $listingType+" and " + $animal + " in " + $county); // debug code
...
// the function below gets the user location and sets the $geolatitude and $geolongitude global variables.
...
if ($agree_to_terms=="0")
	{
	$('#addAListingFeedback').html("<p>You must agree to the Terms & Conditions in order to place an advertisement.</p>");
	}
else
	{
	...
	xmlhttp.onreadystatechange=function()
	  {
		...
		$('#addedListing').html($previewText);
		$('#previewAddedListingTitle').html("<p id='addalistingTitle'>"+$advertTitle+"</p>");
...
// addAListingPreview.php receives the raw information and adds information from the database tables users, pet_type, location_counties and sends it back in order.
	xmlhttp.open("GET",useurl+"addAListingPreview.php?userid="+$id+"&allowEmail="+$contact_by_email+"&animal="+$animal+"&county="+$county+"&advertTitle="+$advertTitle+"&description="+$description+"&price="+$price+"&listingType="+$listingType+"&day="+$day+"&month="+$month+"&year="+$year,true);
	xmlhttp.send();
...
xmlhttp.onreadystatechange=function()
  {
	...
	$ads_id = xmlhttp.responseText; // test code
		if (parseInt($ads_id) > 4491)
			{
			$('#uploadFeedback').html("<p>Ad upload successful "+$ads_id+"</p>"); // remove $ads_id later
			...
			{
			$('#uploadFeedback').html("<p>"+$ads_id+"</p>"); // test code		
			}
	}
  };
...
xmlhttp.onreadystatechange=function()
  {
	...
	$photo_id = xmlhttp.responseText; // test code
		if (parseInt($photo_id) > 6795)
			{
			$('#photoUploadFeedback').html("<p>Photo upload successful "+$photo_id+"</p>"); // remove $photo_id later
			}
		else
			{
			$('#photoUploadFeedback').html("<p>"+$photo_id+"</p>"); // test code		
			}
	}
  };
...
xmlhttp.onreadystatechange=function()
  {
    if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
		if (xmlhttp.responseText == "Sorry")
			{
			window.location = 'index.html#mylistingsNoResults';
			}
		else
			{
			// append the list from myListings.php to myListingsdblistdblist
			$('#myListingsdblist').append(xmlhttp.responseText);
...
xmlhttp.onreadystatechange=function()
  {
	...
	$price = jsonObject.price;
	$dateAdded = jsonObject.day+"/"+jsonObject.month+"/"+jsonObject.year;
	$dateLostFound = jsonObject.lfday+"/"+jsonObject.lfmonth+"/"+jsonObject.lfyear;
	$adType = jsonObject.adType;
	$telephone = jsonObject.telephone;
	$email = jsonObject.email;
	$contact = jsonObject.ownersName;

	document.getElementById("ChosenPetListingTitle").innerHTML="<p id='myListingTitle'>"+$title+"</p>";
	if ($adType == 1)
		{
		document.getElementById("subtitle").innerHTML="<strong>For Good Home</strong>";
		}
	else
		{
		document.getElementById("subtitle").innerHTML="<strong>Lost/Found "+$dateLostFound+"</strong>";
		}
	document.getElementById("chosenPetListingLocation").innerHTML="Location&nbsp&nbsp Co. "+$county;
	document.getElementById("chosenPetListingAdded").innerHTML="Added&nbsp&nbsp&nbsp&nbsp&nbsp "+$dateAdded;
	document.getElementById("chosenPetListingContact").innerHTML="Contact&nbsp&nbsp&nbsp "+$contact;
	
	document.getElementById("chosenPetListingPrice").innerHTML= "Price&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp "+$price;

	document.getElementById("chosenPetListingPhone").innerHTML="Phone&nbsp&nbsp&nbsp&nbsp&nbsp "+$telephone;
	document.getElementById("chosenPetListingPhoneDiv").innerHTML='<a href="tel:'+$telephone+'"><img id="mylisting3phone" onMousedown="downImg17(this)" onMouseup="upImg17(this)" src="ButtonPhoneUpScaled.png"></a>';


	if ($email == "")
		{
		document.getElementById("chosenPetListingEmail").innerHTML="";
		document.getElementById("chosenPetListingEmailDiv").innerHTML=""; // clear any previous icon
		}
	else
		{
		document.getElementById("chosenPetListingEmail").innerHTML= "Email&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp "+$email;
		document.getElementById("chosenPetListingEmailDiv").innerHTML='<a href="mailto:'+$email+'"><img id=mylistingEmailIcon class="emailIcon" onMousedown="downImg18(this)" onMouseup="upImg18(this)" src="ButtonEmailUpScaled.png"></a>';
		}
	document.getElementById("chosenPetListingDescription").innerHTML=$description;

	// these two lines are necessary to render the edit and delete buttons correctly due to a jQueryMobile fault.
/*	document.getElementById("editbuttondiv").innerHTML='<a href="javascript:editListing()"><img id="editMyListingButton" onMousedown="downImg29(this)" onMouseup="upImg29(this)" src="MyAdsEditButtonUpScaled.png"/></a>';
	document.getElementById("deletebuttondiv").innerHTML='<a href="javascript:deleteListing()"><img id="deleteMyListingButton" onMousedown="downImg28(this)" onMouseup="upImg28(this)" src="MyAdsDeleteButtonUpScaled.png"/></a>';
*/
    }
  };
xmlhttp.open("GET",useurl+"getChosenListing.php?theID="+$ads_id,true);
...
//$('#editListingFeedback').html('edit button clicked!'); // debug code
editListing($photoID,$ads_id);
});
$('#deleteMyListingButton').button().bind("click", function(){
//$('#deleteListingFeedback').html('Delete button clicked!'); // debug code
...
//window.location = 'index.html#editUpdateListing';
...
xmlhttp.onreadystatechange=function()
  {
	...
	$servererrors = jsonObject.errors;
...
//$('#editListingFeedback').html('Server errors are: '+$servererrors); // debug code
...
// the buttons below are written from here due to a jQueryMobile fault
//$('#editUpdateListingCaptureButtonDiv').html('<button id="editUpdateListingCapture"><img src="TakePhotoButtonUpScaled"/></button>');

//$('#editUpdateListingGetImageButtonDiv').html('<button id="editUpdateListingGetImage"><img src="UploadPhotoButtonUpScaled"/></button>');

//$('#editMyListingPreviewButtonDiv').html('<a href="#previewEditedListing"><img id="editMyListingPreviewButton" onMousedown="downImg26(this)" onMouseup="upImg26(this)" src="PreviewYourAdButtonUpScaled.png"/></a>')
...
{
// window.location = 'index.html#previewEditedListing';

$(document).ready(function(){
$('#editMyListingPreviewButton').bind("click", function(){

	$listingType = $('#editlistingType').val();
	...
	updateListingPreviewDataCheck($photoID,$ads_id,$animal,$county,$listingType,$advertTitle,$description,$price,$date,$phone,$email,$contact_by_email);
});//close bind function
});//close document ready function
}
...
function updateListingPreviewDataCheck($photoID,$ads_id,$animal,$county,$listingType,$advertTitle,$description,$price,$date,$phone,$email,$contact_by_email)
{
	window.location = 'index.html#previewEditedListing';
	...
	document.getElementById("editedListingTitleDiv").innerHTML="<p id='editedListingTitle'>"+$title+"</p>";
	if ($listingType == "1")
		{
		document.getElementById("editedsubtitle").innerHTML="<strong>For Good Home</strong>";
		}
	if ($listingType == "2")
		{
		document.getElementById("editedsubtitle").innerHTML="<strong>Lost/Found "+$dateLostFound+"</strong>";
		}
	document.getElementById("editedListingLocation").innerHTML="Location&nbsp&nbsp Co. "+$county;
	document.getElementById("editedListingAdded").innerHTML="Added&nbsp&nbsp&nbsp&nbsp&nbsp "+$dateAdded;
	document.getElementById("editedListingContact").innerHTML="Contact&nbsp&nbsp&nbsp "+$contact;
	if ($listingType == "1")
		{
		document.getElementById("editedListingPrice").innerHTML= "Price&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp EUR"+$price;
		}

	document.getElementById("editedListingPhone").innerHTML="Phone&nbsp&nbsp&nbsp&nbsp&nbsp "+$telephone;
	document.getElementById("editedListingPhoneDiv").innerHTML='<a href="tel:'+$telephone+'"><img id="editedlisting3phone" onMousedown="downImg17(this)" onMouseup="upImg17(this)" src="ButtonPhoneUpScaled.png"></a>';


	if ($contact_by_email == "0")
		{
		document.getElementById("editedListingEmail").innerHTML="";
		document.getElementById("editedListingEmailDiv").innerHTML=""; // clear any previous icon
		}
	else
		{
		document.getElementById("editedListingEmail").innerHTML= "Email&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp "+$email;
		document.getElementById("editedListingEmailDiv").innerHTML='<a href="mailto:'+$email+'"><img id=editedlistingEmailIcon class="emailIcon" onMousedown="downImg18(this)" onMouseup="upImg18(this)" src="ButtonEmailUpScaled.png"></a>';
		}
	document.getElementById("editedListingDescription").innerHTML=$description;
...
// $animal_id must be between 67 and 75 inc.
		if (parseInt($animal_id) > 66 && parseInt($animal_id) < 76)
			{
			$('#updateFeedback').html("Ad update successful");
