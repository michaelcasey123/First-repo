...
WHERE a.date_created > '2012-06' AND a.status = 'active' AND p.name = '".$pettype."' AND c.name = '".$theCounty."' AND t.name = 'Lost & Found' AND (a.title LIKE '%found%' OR a.description LIKE '%found%') ORDER BY a.date_created DESC;";
...
// $htmlString is a variable to build the complete list before displaying it
	...
	{
		$htmlString .=  "<li><a href='javascript:getChosenFoundPetListing(" ; // start list item 
