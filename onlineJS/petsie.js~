...
xmlhttp.open("GET","http://michaelcasey123.zxq.net/petsie/rehomeSearchOnlineDB.php?pettype="+$animal+"&theCounty="+$county,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","http://michaelcasey123.zxq.net/petsie/getOnlinePetPhoto.php?theID="+$photoID,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","http://michaelcasey123.zxq.net/petsie/getChosenListingOnline.php?theID="+$photoID,true);
xmlhttp.send();
...
xmlhttp.open("GET","http://michaelcasey123.zxq.net/petsie/lostSearchOnlineDB.php?pettype="+$animal+"&theCounty="+$county,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","http://michaelcasey123.zxq.net/petsie/foundSearchOnlineDB.php?pettype="+$animal+"&theCounty="+$county,true);
xmlhttp.send();
}
